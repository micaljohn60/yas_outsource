                   ...
                   >
                    <div class="sm:w-1/3 md:1/4 w-full flex-shrink flex-grow-0 pt-4 px-3">
                        <div class="sticky top-0  w-full">
                            <ul
                                class="bg-white h-screen rounded-md flex sm:flex-col overflow-auto content-center lg:w-96 sm:w-screen">
                                <!-- nav goes here -->
                                ...
                                @if ($notification->type === 'App\Notifications\SendCommentNotification')
                                    <li class="mt-3 p-2 hidden lg:block">
                                        <a class="  ">
                                            <div
                                                class="p-2 bg-white hover:bg-gray-200 rounded hover:cursor-pointer">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        <p class="text-md line-clamp-1 w-56">
                                                            <a href="{{ route('biz.show', $notification->data['biz_id']) }}">
                                                                You have got a comment at Business
                                                            </a>
                                                        </p>
                                                        <p class="text-sm text-gray-700 mt-1 line-clamp-2 w-56">Test large
                                                            screen</p>
                                ...
                                @else
                                    <li class="mt-3 p-2 hidden lg:block"  onclick='fetchProposal({{$notification->data["biz_id"]}},{{$notification->data["id"]}},{{Auth::user()->type->value == "buyer" ? 1 : 2 }},{{$notification->notifiable_id}})'>
                                        <a class="  ">
                                            <div id="{{ $notification->notifiable_id }}"
                                                class="p-2 bg-white hover:bg-gray-200 rounded hover:cursor-pointer">
                                                <div class="flex items-center">
                                                    <div id={{ 'leading' }}
                                                        class="bg-orange-400 w-12 h-12 flex justify-center items-center rounded-md uppercase font-bold text-white">
                                                    ...
                                                    <div class="ml-4">
                                                        <p class="text-md line-clamp-1 w-56">
                                                            {{ Auth::user()->type->value == 'buyer' ? 'Your Proposal was Accepted' : 'Someone Sent you a Proposal' }}
                                                        </p>
                                                        <p class="text-sm text-gray-700 mt-1 line-clamp-2 w-56">Test large
                                                            screen</p>
                                        ...
                                        <div id="{{ $notification->notifiable_id }}"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    ...
                                                    <p class="text-sm text-gray-700 mt-1 line-clamp-2 w-56">Test mobile
                                                    </p>
    ...
    <script>
        function fetchProposal(bizId, ProposalId, userValue, notiId) {
            ...
            if (userValue == 1) {
                ...
                noti.classList.remove('bg-gray-300');
                noti.className += " bg-white";
            }
            
            noti.classList.remove('bg-white');
            noti.className += " bg-gray-300";
            document.getElementById("heading").textContent =
                "{{ Auth::user()->type->value == 'buyer' ? 'Your Proposel was Accepted ' : 'Someone Sent You a Proposal' }} "
