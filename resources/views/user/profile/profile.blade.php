    ...
    <div class="p-4 sm:ml-64 px-16 py-6 md:col-span-5 lg:col-span-7 bg-gray-100 h-full">
        ...
        <div class="bg-white border-gray-300 rounded-lg p-3 ">
            ...
            <div
                ...
                <div class="flex">
                    <img class="rounded-full w-20 h-20 ml-5" src="https://flowbite.com/docs/images/examples/image-4@2x.jpg"
            ...
            <form action="{{ route('profile.save') }}" method="POST">
                ...
                <div class="bg-white border-gray-300 rounded-lg p-3">
                    ...
                    <div class="flex justify-start items-center my-6"><span
                            ...
                            <input id="toggle" type="checkbox" class="sr-only peer" checked={{auth()->user()->anonymous == "on" ? "true" : "false" }} name="anonymous"
                        ...
                        </label><span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Privacy On</span>
                    </div>
