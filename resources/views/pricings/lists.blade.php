    ...
    <section class="bg-white">
       ...
       <div class="py-8 px-4 mx-auto max-w-screen-xl lg-py-16 lg:px-6">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam itaque, aliquid molestiae consequatur ratione voluptatibus reprehenderit distinctio, autem quos quis exercitationem id officiis illo molestias deserunt quisquam omnis, corporis maxime.</p>
        </div>
