...
<body class="bg-gray-100">
    ...
    <form class="mt-2" action="{{ route('biz.index') }}" method="GET">
      <div class="grid md:grid-cols-4 md:gap-6 px-10 text-center">
          ...
          <div class="relative z-0 w-full mb-3 mt-3 group">
              <input type="submit"
                  class="px-3 w-full py-2 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
