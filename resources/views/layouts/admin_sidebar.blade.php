        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="{{ (request()->is('admin/dashboard')) ? 'active' : '' }}">
                    <a href=""><i class="fa-solid fa-shapes mx-3"></i> Dashboard </a>
                </li>
                ...
                <li class="{{ (request()->is('admin/roleandpermissions')) ? 'active' : '' }}">                    
                    <a href=""><i class="fa-solid fa-user-secret mx-3"></i> Roles & Permissions</a>
                </li>

                <li class="{{ (request()->is('admin/users')) ? 'active' : '' }}">                    
                    <a href=""><i class="fa-solid fa-usersslot mx-3"></i> Users </a>
                </li>
