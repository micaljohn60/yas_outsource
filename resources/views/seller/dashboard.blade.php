                            ...
                            @foreach ($bizs as $key => $biz)
                                <tr
                                    ...
                                    <td class="px-6 py-4 flex gap-2">
                                        <a href="{{route('biz.edit',$biz->id)}}" class="font-medium text-main dark:text-main hover:underline"><i
                                        ...
                                        <div class="relative w-full h-full max-w-md md:h-auto">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <form action="{{route('biz.delete',$biz->id)}}" method="POST">
                                                        @method('delete')
                                                        @csrf
                                                        <input type="submit" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" value="Yes, I'm sure {{$biz->id}}"/>
